...
function patchRoute(route, pagesPath, parentRoutePath) {
  ...
  if (route.path && route.path.charAt(0) !== '/') {
    route.path = (0, _winPath.default)((0, _path.join)(parentRoutePath, route.path));
    ...
    if (route.indexRoute) {
      if (route.indexRoute.redirect) {
        ...
        if (redirect.charAt(0) !== '/') {
          redirect = (0, _winPath.default)((0, _path.join)(route.path, redirect));
        }
  ...
  if (route.redirect && route.redirect.charAt(0) !== '/') {
    route.redirect = (0, _winPath.default)((0, _path.join)(parentRoutePath, route.redirect));
  }
